...
| Administrer la machine | « Gérant » disait deux choses : qui arbitre une indivision, et qui tient le serveur. La personne qui héberge devait se nommer gérante d'une indivision où elle n'a rien à arbitrer. | Un **second droit**, `personne.admin_plateforme`, indépendant des rôles : il ouvre l'Administration et n'ouvre aucun bien. Un attribut plutôt qu'un rôle, parce qu'il ne se rapporte à aucune structure et n'a pas de date d'effet. |
